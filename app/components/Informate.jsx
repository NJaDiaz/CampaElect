...
const novedades = [
  {
    ...
    descripcion: "El Presidente del HCD no puso a consideración el pedido de informe solicitado por Daniel Orlando",
...
export default function Informate() {
  ...
  return (
    <section className="bg-white py-20 px-6 md:px-12 space-y-12">
    ...
    <div className="p-6 space-y-4">
      ...
      {modalOpen && modalData && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg max-w-lg w-full p-6 space-y-4 shadow-xl relative">
            <button
